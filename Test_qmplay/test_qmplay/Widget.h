...
private:
/*    QWidget(parent),  ui(new Ui::Widget),  PADDING(2), buttonWidth(20), buttonHeight(20), isLeftPressDown(false),
    dir(NONE),windowIniWidth((QApplication::desktop()->availableGeometry().width())*29/48),
    playingIndex(-1),                          windowIniHeight((QApplication::desktop()->availableGeometry().height())*20/27),
                                     ...
                                     screenHeight(QApplication::desktop()->availableGeometry().height()), clickCount(1)*/
    Ui::Widget      * ui;
    ...
    QVector<QPair<QPair<QString, QString>, QString > > vector;
